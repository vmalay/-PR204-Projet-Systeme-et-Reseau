...
#define PATH_DSMWRAP "/net/t/vmalay/T2/PROJET_SYST/Phase2/bin/dsmwrap"
#define PATH_TRUC "/net/t/vmalay/T2/PROJET_SYST/Phase2/bin/truc"
...
int main(int argc, char *argv[])
{
  if (argc < 3){
    ...
    for(k = 0; k < num_procs ; k++){
      ...
      sprintf(buffer,"%d %d %d %s", num_procs, proc[k].rang, proc[k].port_distant, proc[k].hostname);
